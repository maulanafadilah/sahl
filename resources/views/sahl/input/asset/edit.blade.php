          ...
          <form method="POST" action="/asset/{{$asset->id}}">
            ...
            @csrf
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control mb-4 mb-md-0" data-inputmask="'alias': 'currency', 'prefix':'Rp'" name="nominal" placeholder="masukkan nominal" id="nominal" value="{{$asset->nominal}}" required/>
                </div>

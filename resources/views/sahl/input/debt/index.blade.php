...
<div class="row">
  <div class="col-md-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <div class="card-title d-flex justify-content-between"><h6>Tabel Utang</h6><span><a href="/utang/create" class="btn btn-inverse-primary" >Tambah Utang</a></span></div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="row">
                    <div class="col-sm-2">
                      <a href="/utang/{{$item->id}}/edit" class="btn btn-primary btn-icon">
                        <i data-feather="edit"></i>
                      </a>
                    </div>
                    <div class="col-sm">
                      <form action="/utang/{{$item->id}}" method="post">
                        @csrf
                        @method('DELETE')

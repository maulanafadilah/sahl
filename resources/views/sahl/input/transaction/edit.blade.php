          ...
          <form method="POST" action="/jurnal-umum/{{$transaction->id}}">
            ...
            @csrf
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control mb-4 mb-md-0" data-inputmask="'alias': 'currency', 'prefix':'Rp'" name="nominal" placeholder="masukkan nominal" id="nominal" value="{{$transaction->debit}}" required/>
                </div>

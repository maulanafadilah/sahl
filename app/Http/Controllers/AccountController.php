...
class AccountController extends Controller
{
    ...
    public function show($id, $account)
    {
        ...
        // $posting_kredit = General_journal::select(DB::raw('SUM(general_journals.kredit) as pkredit'))->where('general_journals.id_pengguna', $id_pengguna)->where('general_journals.tanggal', 'LIKE', '%'.$year.'%')->where('transactions.kredit', 'LIKE', '%'.$acc.'%')->join('transactions', 'general_journals.id_transaksi', '=', 'transactions.id')->get();
        
        // return $posting_kredit;
